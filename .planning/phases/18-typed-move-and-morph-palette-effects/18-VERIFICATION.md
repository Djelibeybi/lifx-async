...
covered_digest: "v1:sha256:196723136839723a1d985939e8fb851f738fca17844e28d9cee49af8e47a3de4"
...
- `test_raw_set_effect_sends_only_set_effect_and_zones_unchanged` now reads the zones back before its capture window, closing a CI race: the emulator acks the setup paint (packet 510) before processing it, so it could land inside the window. Test-only; digest recomputed.
