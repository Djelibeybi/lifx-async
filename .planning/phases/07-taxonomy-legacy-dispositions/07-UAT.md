...
- gap_id: G-07-1
  ...
  missing:
    - "Rename docs/migration/theme-taxonomy-v1.2.md to theme-taxonomy-6.3.0.md (git mv)"
    - "Replace every `v1.2` with `6.3.0` across the four files, including the get_by_category() ValueError text"
  ...
  decision: "User selected release version 6.3.0 over a date; no redirect. 6.3.0 confirmed as the next release — branch carries feat commits and zero BREAKING CHANGE footers, so semantic-release computes a minor bump from 6.2.0."
  debug_session: ""
