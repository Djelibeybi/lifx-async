# Requirements Archive: v1.1 Wire Reliability
...
- [x] **ANIM-03**: Hardware validation resolved by operator ruling: the cross-device
  ...
  operator's visual smoothness verdict on Test Ceiling Capsule (04-13 Task 4).
...
- [x] **ANIM-04**: Flow control covers the large-matrix framebuffer path (multi-packet
  ...
  devices). Test Ceiling Capsule is 16×8 zones (128 zones; 26 in × 13 in physical —
