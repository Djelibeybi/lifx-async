...
For a simpler single-color hue rotation, see effects_colorloop.py.

Usage:
    # Discover all lights on the network
    python effects_rainbow.py

    # Target specific devices by IP address
    python effects_rainbow.py 192.168.1.100 192.168.1.101

    # Target specific devices by serial number
    python effects_rainbow.py d073d5123456 d073d5abcdef

    # Mix IP addresses and serial numbers
    python effects_rainbow.py 192.168.1.100 d073d5123456
"""
